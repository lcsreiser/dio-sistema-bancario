...
def depositarOuSacar(clientes, opcao):
...
def criar_cliente(clientes):
    ...
    endereco = input("Informe o endereço (logradouro, nro - bairro - cidade/sigla esado): ")
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            depositarOuSacar(clientes, opcao)
            ...
            print("\n> Operação inválida, por favor slecione novamente a operação desejada. <")
